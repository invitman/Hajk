...
var PanelView = {
  ...
  clickSwipeBtn: function() {
    if (
      $("#sidebar-toggle-swipe")[0].classList.contains("sidebar-open-after")
    ) {
  ...
  render: function() {
    if (!isMobile || !mobilAnpassningEnabled) {
      ...
      var instructionTxt;
      if (
        typeof this.props.instruction !== "undefined" &&
        this.props.instruction !== null &&
        this.props.instruction.length > 0
      ) {
        instructionBtn = (
          <i
            onClick={() => this.openInstruction()}
            className="fa fa-question-circle clickable btn-info"
            id="instructionBox1"
          />
        );
        instructionTxt = (
          <div
            ...
            id="instructionsText"
            dangerouslySetInnerHTML={{ __html: this.props.instruction }}
          />
        );
      }
      ...
      if (
        typeof firstTimeOpenedPanelMobile === "undefined" ||
        firstTimeOpenedPanelMobile < 2
      ) {
      ...
      return (
        <div className={containerClass}>
          ...
          <div className="main-content-swipe">
            ...
            <a
              data-toggle=".container-swipe-menu"
              id="sidebar-toggle-swipe"
